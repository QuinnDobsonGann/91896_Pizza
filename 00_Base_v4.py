...
# Update order dictionary with drinks
order_dict.update({"Drink": user_order_drinks, "Drink Price": user_order_drink_cost})
...
with open(write_to, "w") as text_file:
    ...
    # confirm your order, prevent accidental purchase
    not_blank = string_checker("Do you want to confirm this order?(y/n) ", 1, yes_no_list)
